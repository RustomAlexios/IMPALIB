...
//export LD_LIBRARY_PATH=../. //export was needed to make sure library is observed
//g++ -o mycode example1.cpp -L../. -lcnpy -lz --std=c++11 //The L path is where the installation was done
