...
def ut_equality_constraint(
    ...
    f_input1 = (
        os.getcwd()
        + "/../ut_inputs/ut_EqualityConstraint/ut_"
        + ut_name
        + "/degree_constraint_to_eq_constraint_m_pure.npy"
    )
    ...
    f_input2 = (
        os.getcwd() + "/../ut_inputs/ut_EqualityConstraint/ut_" + ut_name + "/edge_degree_constraint_cost_pure.npy"
    )
    ...
    if ut_name == "EdgeEc2DegreeConstraintRelaxedGraphUpdate":
        ...
        f_output_path = (
            os.getcwd() + "/../ut_results/ut_EqualityConstraint/ut_" + ut_name + "/edge_ec_to_degree_constraint_m_pure"
        )
        ...
        f_input5 = (
            os.getcwd() + "/../ut_inputs/ut_EqualityConstraint/ut_" + ut_name + "/delta_S_indices_list_sizes_pure.npy"
        )
        ...
        f_input6 = (
            ...
            + "/../ut_inputs/ut_EqualityConstraint/ut_"
            + ut_name
            + "/subtour_constraints_to_edge_ec_m_pure.npy"
        )
        ...
        f_output_path = (
            os.getcwd()
            + "/../ut_results/ut_EqualityConstraint/ut_"
            + ut_name
            + "/edge_ec_to_subtour_constraints_m_pure"
        )
        output_file_python_pure = open(f_output_path, "wb")
