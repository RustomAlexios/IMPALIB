...
if __name__ == "__main__":
    ...
    if ut_name == "ExtrinsicOutputEdgeEcRelaxedGraphUpdate":
        ...
        f_path_wrapper = (
            "../ut_results/ut_InputOutput/ut_" + ut_name + "/extrinsic_output_edge_ec_relaxed_graph_wrapper"
        )
        ...
        f_path_wrapper = (
            "../ut_results/ut_InputOutput/ut_" + ut_name + "/extrinsic_output_edge_ec_augmented_graph_wrapper"
        )
        ...
        f_path_wrapper = (
            "../ut_results/ut_DegreeConstraint/ut_" + ut_name + "/degree_constraint_to_eq_constraint_m_wrapper"
        )
        ...
        f_path_wrapper = (
            "../ut_results/ut_SubtourConstraint/ut_" + ut_name + "/subtour_constraints_to_edge_ec_m_wrapper"
        )
        ...
        f_path_wrapper = (
            "../ut_results/ut_EqualityConstraint/ut_" + ut_name + "/edge_ec_to_subtour_constraints_m_wrapper"
        )
    ...
    if (
        ut_name == "ExtrinsicOutputEdgeEcRelaxedGraphUpdate"
        or ut_name == "ExtrinsicOutputEdgeEcAugmentedGraphUpdate"
        or ut_name == "DegreeConstraint2EdgeEcUpdate"
        or ut_name == "SubtourConstraints2EdgeEcUpdate"
        or ut_name == "EdgeEc2DegreeConstraintRelaxedGraphUpdate"
        or ut_name == "EdgeEc2SubtourConstraintsUpdate"
        or ut_name == "EdgeEc2DegreeConstraintAugmentedGraphUpdate"
        or ut_name == "IterateRelaxedGraph"
        or ut_name == "IterateAugmentedGraph"
    ):
