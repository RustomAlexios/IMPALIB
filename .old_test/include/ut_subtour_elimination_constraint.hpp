...
void ut_subtour_constraint(string ut_name){
    ...
    cnpy::NpyArray input_alpha = cnpy::npy_load("../ut_inputs/ut_SubtourConstraint/ut_"+ ut_name+"/alpha.npy");
    ...
    cnpy::NpyArray input1 = cnpy::npy_load("../ut_inputs/ut_SubtourConstraint/ut_"+ ut_name+"/edge_ec_to_subtour_constraints_m_pure.npy");
    ...
    cnpy::NpyArray input2 = cnpy::npy_load("../ut_inputs/ut_SubtourConstraint/ut_"+ ut_name+"/delta_S_indices_list_sizes_pure.npy");
    const int* delta_S_indices_list_sizes_pure = input2.data<int>();

    cnpy::NpyArray input3 = cnpy::npy_load("../ut_inputs/ut_SubtourConstraint/ut_"+ ut_name+"/delta_S_indices_list_pure.npy");
    ...
    if (ut_name == "SubtourConstraints2EdgeEcUpdate"){
        ...
        fstream file_output("../ut_results/ut_SubtourConstraint/ut_"+ ut_name+"/subtour_constraints_to_edge_ec_m_wrapper", ios::out | ios::binary | ios:: trunc);
