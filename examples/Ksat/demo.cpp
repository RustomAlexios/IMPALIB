...
int main() {
    ...
    array<array<impalib_type, NUM_VARIABLES>, NUM_CONSTRAINTS> variable_ec_to_ksat_constraint_m = {{{0., 0., 4.37984813, -7.13066003, -2.15600797}, {-2.66808398, 0., 4.37984813, -7.13066003, 0.}}};
