...
parser.add_argument('--simAnnSolFlag', type=bool, default=False, help="Run Simulated Annealing-heuristic solver or not")
parser.add_argument('--resetFlag', type=bool, default=False, help="Number of Sampled combinations per size for augmentation")
...
parser.add_argument('--randomTestFlag', type=bool, default=False, help="Generate random test or use test files")
parser.add_argument('--inputPath', metavar='path', default = '../../data/impa_input', type=str, help='path to output directory')
parser.add_argument('--outputPath', metavar='path', default = '../../data/impa_output', type=str, help='path to output directory')
...
if __name__ == '__main__':
    ...
    ModelIMPA = GraphicalModelTsp(NUM_ITERATIONS, NUM_NODES, SYMMETRIC_FLAG, AUGMENTATION_FLAG, EXACT_SOLVER_FLAG, LKH_SOLVER_FLAG, SIM_ANNEALING_FLAG, RESET_FLAG, FILTERING_FLAG, ALPHA, THRESHOLD, RANDOM_TEST_FLAG, MAX_COUNT, POST_PROCESS_FLAG, K_OPT_FLAG, MAX_AUGM_COUNT)
