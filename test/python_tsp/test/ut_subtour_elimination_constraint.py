...
def ut_subtour_constraint(ut_name, n_edge_variables, n_nodes, filt_flag, alpha, n_subtours):
    ...
    f_input1  = os.getcwd() + '/../ut_inputs/ut_SubtourConstraint/ut_'+ ut_name+'/edge_ec_to_subtour_constraints_m_pure.npy'
    ...
    f_input2  = os.getcwd() + '/../ut_inputs/ut_SubtourConstraint/ut_'+ ut_name+'/delta_S_indices_list_pure.npy'
    np.save(f_input2, np.array(delta_S_indices_list_flattened, dtype=np.int32).flatten())
    
    f_input3  = os.getcwd() + '/../ut_inputs/ut_SubtourConstraint/ut_'+ ut_name+'/delta_S_indices_list_sizes_pure.npy'
    np.save(f_input3, np.array(delta_S_indices_list_sizes, dtype=np.int32).flatten())
    
    f_input_alpha = os.getcwd() + '/../ut_inputs/ut_SubtourConstraint/ut_'+ ut_name+'/alpha.npy'
    ...
    if (ut_name == "SubtourConstraints2EdgeEcUpdate"):        
        ...
        f_output_path  = os.getcwd() + '/../ut_results/ut_SubtourConstraint/ut_'+ ut_name+'/subtour_constraints_to_edge_ec_m_pure'
