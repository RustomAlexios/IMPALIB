...
def ut_equality_constraint(ut_name, n_edge_variables, n_nodes, filt_flag, alpha, n_subtours, edge_connections, augm_flag, edge_degree_constraint_cost, cost_edge_variable):
    ...
    f_input1  = os.getcwd() + '/../ut_inputs/ut_EqualityConstraint/ut_'+ ut_name+'/degree_constraint_to_eq_constraint_m_pure.npy'
    ...
    f_input_alpha = os.getcwd() + '/../ut_inputs/ut_EqualityConstraint/ut_'+ ut_name+'/alpha.npy'
    np.save(f_input_alpha, ALPHA)
    
    f_input2  = os.getcwd() + '/../ut_inputs/ut_EqualityConstraint/ut_'+ ut_name+'/edge_degree_constraint_cost_pure.npy'
    ...
    f_input3  = os.getcwd() + '/../ut_inputs/ut_EqualityConstraint/ut_'+ ut_name+'/edge_connections_pure.npy'
    ...
    if (ut_name == "EdgeEc2DegreeConstraintRelaxedGraphUpdate"):        
        ...
        f_output_path  = os.getcwd() + '/../ut_results/ut_EqualityConstraint/ut_'+ ut_name+'/edge_ec_to_degree_constraint_m_pure'
        ...
        f_input4  = os.getcwd() + '/../ut_inputs/ut_EqualityConstraint/ut_'+ ut_name+'/delta_S_indices_list_pure.npy'
        np.save(f_input4, np.array(delta_S_indices_list_flattened, dtype=np.int32).flatten())
        
        f_input5  = os.getcwd() + '/../ut_inputs/ut_EqualityConstraint/ut_'+ ut_name+'/delta_S_indices_list_sizes_pure.npy'
        np.save(f_input5, np.array(delta_S_indices_list_sizes, dtype=np.int32).flatten())
        
        f_input6  = os.getcwd() + '/../ut_inputs/ut_EqualityConstraint/ut_'+ ut_name+'/subtour_constraints_to_edge_ec_m_pure.npy'
        ...
        f_input7  = os.getcwd() + '/../ut_inputs/ut_EqualityConstraint/ut_'+ ut_name+'/cost_edge_variable_pure.npy'
        cost_edge_variable_pure = cost_edge_variable.astype(np_impa_lib)
        np.save(f_input7, cost_edge_variable_pure.flatten())
        
        
        edge_ec_to_subtour_constraints_m_pure = model_equality_constraint.edge_ec_to_subtour_constraints_update(degree_constraint_to_eq_constraint_m_pure, subtour_constraints_to_edge_ec_m_pure, delta_S_indices_list, cost_edge_variable_pure)
        edge_ec_to_subtour_constraints_m_pure = np.array(edge_ec_to_subtour_constraints_m_pure)
        f_output_path  = os.getcwd() + '/../ut_results/ut_EqualityConstraint/ut_'+ ut_name+'/edge_ec_to_subtour_constraints_m_pure'
        output_file_python_pure = open(f_output_path, 'wb')
        ...
        f_input8  = os.getcwd() + '/../ut_inputs/ut_EqualityConstraint/ut_'+ ut_name+'/subtour_constraints_to_edge_ec_m_pure.npy'
        subtour_constraints_to_edge_ec_m_pure = np.random.uniform(10,500, size = (N_SUBTOURS, N_EDGE_VARIABLES))
        for row_idx, subtour_indices in enumerate(delta_S_indices_list):
            for col_idx in range(N_EDGE_VARIABLES):
                if col_idx not in subtour_indices:
        ...
        edge_ec_to_degree_constraint_m_pure = model_equality_constraint.edge_ec_to_degree_constraint_augmented_graph_update(degree_constraint_to_eq_constraint_m_pure, subtour_constraints_to_edge_ec_m_pure)
        edge_ec_to_degree_constraint_m_pure = np.array(edge_ec_to_degree_constraint_m_pure)
        f_output_path  = os.getcwd() + '/../ut_results/ut_EqualityConstraint/ut_'+ ut_name+'/edge_ec_to_degree_constraint_m_pure'
        output_file_python_pure = open(f_output_path, 'wb')
        np.save(output_file_python_pure, edge_ec_to_degree_constraint_m_pure.flatten(), allow_pickle=True)
