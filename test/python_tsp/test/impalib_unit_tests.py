...
if __name__ == "__main__":
    ...
    if ut_name == "ExtrinsicOutputEdgeEcRelaxedGraphUpdate" or ut_name == "ExtrinsicOutputEdgeEcAugmentedGraphUpdate":
        ...
        ut_update_degree_constraint.ut_degree_constraint(
            ut_name=ut_name,
            n_edge_variables=N_EDGE_VARIABLES,
            n_nodes=N_NODES,
            edge_connections=EDGE_CONNECTIONS,
        ...
        ut_subtour_elimination_constraint.ut_subtour_constraint(
            ut_name=ut_name,
            n_edge_variables=N_EDGE_VARIABLES,
            n_nodes=N_NODES,
            filt_flag=FILT_FLAG,
        ...
        ut_update_equality_constraint.ut_equality_constraint(
            ...
            edge_connections=EDGE_CONNECTIONS,
            augm_flag=AUGM_FLAG,
            edge_degree_constraint_cost=edge_degree_constraint_cost,
            cost_edge_variable=cost_edge_variable,
        )
