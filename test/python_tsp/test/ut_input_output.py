...
def ut_io(ut_name, n_edge_variables, n_nodes, n_subtours, edge_connections):
    ...
    if ut_name == "ExtrinsicOutputEdgeEcRelaxedGraphUpdate":
        ...
        f_output_path = os.getcwd() + "/../ut_results/extrinsic_output_edge_ec_relaxed_graph_pure"
        ...
        f_input2 = os.getcwd() + "/../ut_inputs/subtour_constraints_to_edge_ec_m_pure.npy"
        ...
        f_output_path = os.getcwd() + "/../ut_results/extrinsic_output_edge_ec_augmented_graph_pure"
        output_file_python_pure = open(f_output_path, "wb")
