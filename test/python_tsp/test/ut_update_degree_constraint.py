...
def ut_degree_constraint(ut_name, n_edge_variables, n_nodes, edge_connections, filt_flag, alpha):
    ...
    f_input1  = os.getcwd() + '/../ut_inputs/ut_DegreeConstraint/ut_'+ ut_name+'/edge_ec_to_degree_constraint_m_pure.npy'
    ...
    if (ut_name == "DegreeConstraint2EdgeEcUpdate"):        
        ...
        f_output_path  = os.getcwd() + '/../ut_results/ut_DegreeConstraint/ut_'+ ut_name+'/degree_constraint_to_eq_constraint_m_pure'
