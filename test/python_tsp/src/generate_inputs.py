...
for i in range(0,samples):
    ...
    upper_triangle = np.random.uniform(1, 1000, size=(num_nodes, num_nodes))
    ...
    input = [num_nodes, symmetric_flag, matrix, edge_connections]
    ...
    with open(f'../../../data/inputs_{type}_{samples}/inputs_set{str(i)}.pkl', 'wb') as f:
