...
parser.add_argument('--nSamples', type=int, default=1000, help="Number of Sampled combinations per size for augmentation")
...
if __name__ == '__main__':
    ...
    ModelIMPA = GraphicalModel(NUM_ITERATIONS, NUM_NODES, SYMMETRIC_FLAG, AUGMENTATION_FLAG, EXACT_SOLVER_FLAG, LKH_SOLVER_FLAG, SIM_ANNEALING_FLAG, NUM_AUGMENTED_SAMPLES_PER_SUBTOUR_SIZE, RESET_FLAG, FILTERING_FLAG, ALPHA, THRESHOLD, RANDOM_TEST_FLAG)
