...
def ut_forward_backward(ut_name, N_u, team_types, filtering_flag, alpha):
    ...
    non_zero_weight_indices_sizes = [len(l) for l in non_zero_weight_indices] #input to C++
    ...
    f_input_alpha = os.getcwd() + '/../ut_inputs/ut_Knapsack/ut_'+ ut_name+'/alpha.npy'
    np.save(f_input_alpha, alpha)
    
    f_input1 = os.getcwd() + '/../ut_inputs/ut_Knapsack/ut_'+ ut_name+'/N_TEAMS_pure.npy'
    np.save(f_input1, N_TEAMS)
    
    f_input2 = os.getcwd() + '/../ut_inputs/ut_Knapsack/ut_'+ ut_name+'/non_zero_weight_indices_sizes_pure.npy'
    np.save(f_input2, np.array(non_zero_weight_indices_sizes, dtype=np.int32).flatten())
    
    f_input3 = os.getcwd() + '/../ut_inputs/ut_Knapsack/ut_'+ ut_name+'/teams_weights_per_department_pure'  
    ...
    f_input4 = os.getcwd() + '/../ut_inputs/ut_Knapsack/ut_'+ ut_name+'/non_zero_weight_indices_arr_pure.npy'  
    ...
    f_input5 = os.getcwd() + '/../ut_inputs/ut_Knapsack/ut_'+ ut_name+'/team_to_knapsack_m_pure.npy'
    ...
    for department_index in range(0, N_DEPARTMENTS):    
        if (ut_name == "KnapsackForward"):
            model_knapsacks.forward(N_u[department_index], team_to_knapsack_m[department_index], teams_weights_per_department[department_index])
            f_pure_path = os.getcwd() + '/../ut_results/ut_Knapsack/ut_'+ ut_name+'/forward_pure' + str(department_index)
            output_file_python_pure = open(f_pure_path, 'wb')
            np.save(output_file_python_pure, model_knapsacks.stage_forward_messages, allow_pickle=True)
            output_file_python_pure.close()
        
        if (ut_name == "KnapsackBackward"):
            model_knapsacks.backward(N_u[department_index], team_to_knapsack_m[department_index], teams_weights_per_department[department_index])
            f_pure_path = os.getcwd() + '/../ut_results/ut_Knapsack/ut_'+ ut_name+'/backward_pure' + str(department_index)
            output_file_python_pure = open(f_pure_path, 'wb')
            np.save(output_file_python_pure, model_knapsacks.stage_backward_messages, allow_pickle=True)
            output_file_python_pure.close()           
...
def ut_extrinsic_output_department(ut_name, N_u, team_types, filtering_flag, alpha):
    ...
    f_input2 = os.getcwd() + '/../ut_inputs/ut_Knapsack/ut_'+ ut_name+'/teams_weights_per_department_pure'  
    ...
    f_input3 = os.getcwd() + '/../ut_inputs/ut_Knapsack/ut_'+ ut_name+'/team_to_knapsack_m_pure.npy'
    ...
    for department_index in range(0, N_DEPARTMENTS):
        ...
        f_input_fv = os.getcwd() + '/../ut_inputs/ut_Knapsack/ut_'+ ut_name+'/stage_forward_messages'+str(department_index)+'.npy'
        np.save(f_input_fv, stage_forward_messages.flatten())
        f_input_bv = os.getcwd() + '/../ut_inputs/ut_Knapsack/ut_'+ ut_name+'/stage_backward_messages'+str(department_index)+'.npy'
        ...
        model_knapsacks.extrinsic_output_department_lhs(department_index, N_u[department_index], team_to_knapsack_m[department_index], teams_weights_per_department[department_index])
        
    f_pure_path = os.getcwd() + '/../ut_results/ut_Knapsack/ut_'+ ut_name+'/extrinsic_output_department_pure'
    output_file_python_pure = open(f_pure_path, 'wb')
    np.save(output_file_python_pure, model_knapsacks.extrinsic_output_department_dummy.flatten(), allow_pickle=True)
    output_file_python_pure.close()
...
def ut_team_to_knapsack_update(ut_name, N_u, team_types, filtering_flag, alpha):
    ...
    f_input3 = os.getcwd() + '/../ut_inputs/ut_Knapsack/ut_'+ ut_name+'/non_zero_weight_indices_arr_pure.npy'  
    ...
    f_input4 = os.getcwd() + '/../ut_inputs/ut_Knapsack/ut_'+ ut_name+'/team_to_knapsack_m_pure.npy'
    np.save(f_input4, team_to_knapsack_m.flatten())
    
    f_input5 = os.getcwd() + '/../ut_inputs/ut_Knapsack/ut_'+ ut_name+'/reward_team_pure.npy'
    ...
    f_input6 = os.getcwd() + '/../ut_inputs/ut_Knapsack/ut_'+ ut_name+'/extrinsic_output_department_pure.npy'
    ...
    f_input7 = os.getcwd() + '/../ut_inputs/ut_Knapsack/ut_'+ ut_name+'/oric_to_team_m_pure.npy'
    ...
    f_pure_path = os.getcwd() + '/../ut_results/ut_Knapsack/ut_'+ ut_name+'/team_to_knapsack_m_pure'
    output_file_python_pure = open(f_pure_path, 'wb')
...
def ut_process_extrinsic_output_department(ut_name, N_u, team_types, filtering_flag, alpha, N_ITER):
    ...
    f_input2 = os.getcwd() + '/../ut_inputs/ut_Knapsack/ut_'+ ut_name+'/extrinsic_output_department_dummy_pure.npy'
    ...
    f_pure_path = os.getcwd() + '/../ut_results/ut_Knapsack/ut_'+ ut_name+'/extrinsic_output_department_pure'
    output_file_python_pure = open(f_pure_path, 'wb')
    np.save(output_file_python_pure, model_knapsacks.extrinsic_output_department, allow_pickle=True)
    output_file_python_pure.close()