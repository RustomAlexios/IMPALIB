...
if __name__ == "__main__":
    ...
    if ut_name == "KnapsackForward" or ut_name == "KnapsackBackward":
        ...
        f_path_pure = "../ut_results/team_to_knapsack_m_pure"
        f_path_wrapper = "../ut_results/team_to_knapsack_m_wrapper"
    elif ut_name == "ProcessExtrinsicOutputDepartment":
        f_path_pure = "../ut_results/extrinsic_output_department_pure"
        f_path_wrapper = "../ut_results/extrinsic_output_department_wrapper"
    elif ut_name == "Oric2TeamUpdate":
        f_path_pure = "../ut_results/oric_to_team_m_pure"
        f_path_wrapper = "../ut_results/oric_to_team_m_wrapper"
    elif ut_name == "Oric2ProjectEcUpdate":
        f_path_pure1 = "../ut_results/eq_constraint_to_project_m_pure"
        f_path_wrapper1 = "../ut_results/eq_constraint_to_project_m_wrapper"
        ...
        f_path_pure2 = "../ut_results/oric_to_eq_constraint_m_pure"
        f_path_wrapper2 = "../ut_results/oric_to_eq_constraint_m_wrapper"
        ...
        f_path_pure = "../ut_results/extrinsic_output_team_pure"
        f_path_wrapper = "../ut_results/extrinsic_output_team_wrapper"
    elif ut_name == "IntrinsicOutMwmUpdate":
        f_path_pure = "../ut_results/intrinsic_out_mwm_pure"
        f_path_wrapper = "../ut_results/intrinsic_out_mwm_wrapper"
    elif ut_name == "TeamEc2OricUpdate":
        f_path_pure = "../ut_results/team_to_oric_m_pure"
        f_path_wrapper = "../ut_results/team_to_oric_m_wrapper"
    elif ut_name == "ProjectEqConst2OricUpdate":
        f_path_pure = "../ut_results/eq_constraint_to_oric_m_pure"
        f_path_wrapper = "../ut_results/eq_constraint_to_oric_m_wrapper"
    elif ut_name == "ProjectInequalityConstraintUpdate":
        f_path_pure = "../ut_results/project_to_eq_constraint_m_pure"
        f_path_wrapper = "../ut_results/project_to_eq_constraint_m_wrapper"
    elif ut_name == "Iterate" or ut_name == "IterateSampleGraph":
        f_path_pure1 = "../ut_results/extrinsic_output_team_pure"
        f_path_wrapper1 = "../ut_results/extrinsic_output_team_wrapper"
        file_array_pure1 = open(f_path_pure1, "rb")
        y_pure1 = np.load(file_array_pure1)
        y_wrapper1 = np.fromfile(f_path_wrapper1, dtype=np_impa_lib)
        check_agreement(
        ...
        f_path_pure2 = "../ut_results/intrinsic_out_mwm_pure"
        f_path_wrapper2 = "../ut_results/intrinsic_out_mwm_wrapper"
        file_array_pure2 = open(f_path_pure2, "rb")
        y_pure2 = np.load(file_array_pure2)
        y_wrapper2 = np.fromfile(f_path_wrapper2, dtype=np_impa_lib)
        check_agreement(
