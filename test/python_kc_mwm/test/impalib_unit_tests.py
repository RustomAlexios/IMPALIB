...
if __name__ == "__main__":
    ...
    if ut_name == "Oric2TeamUpdate" or ut_name == "Oric2ProjectEcUpdate":
        ut_update_or_inequality_constraint.ut_oric(
            ut_name=ut_name,
            n_departments=N_DEPARTMENTS,
            n_teams=N_TEAMS,
            n_projects=N_PROJECTS,
            unbalanced_flag=unbalanced_flag,
        )
        ...
        ut_update_equality_constraint.ut_eq_consraint(
            ut_name=ut_name,
            n_departments=N_DEPARTMENTS,
            n_teams=N_TEAMS,
            n_projects=N_PROJECTS,
        ...
        ut_project_inequality_constraint.ut_project_ineq_constraint(
            ut_name=ut_name,
            n_departments=N_DEPARTMENTS,
            n_teams=N_TEAMS,
            n_projects=N_PROJECTS,
        ...
        N_u = np.array([int(item) for item in args.Nu.split(",")])
        team_types = [int(item) for item in args.pTypes.split(",")]
        filtering_flag = args.fFlag
        alpha = args.alpha
        ut_knapsack.ut_forward_backward(
            ut_name=ut_name,
            N_u=N_u,
        ...
        filtering_flag = args.fFlag
        alpha = args.alpha
        ut_knapsack.ut_extrinsic_output_department(
            ut_name=ut_name,
            N_u=N_u,
            team_types=team_types,
            filtering_flag=filtering_flag,
        ...
        filtering_flag = args.fFlag
        alpha = args.alpha
        ut_knapsack.ut_team_to_knapsack_update(
            ut_name=ut_name,
            N_u=N_u,
            team_types=team_types,
            filtering_flag=filtering_flag,
        ...
        filtering_flag = args.fFlag
        alpha = args.alpha
        ut_knapsack.ut_process_extrinsic_output_department(
            ut_name=ut_name,
            N_u=N_u,
            team_types=team_types,
            filtering_flag=filtering_flag,
        ...
        ppFlag = args.ppFlag
        threshold = args.threshold
        ut_graphical_model.ut_iterate_sample_graph(
            ut_name=ut_name,
            filtering_flag=filtering_flag,
            alpha=alpha,
            N_ITER=N_ITER,
