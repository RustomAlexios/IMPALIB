...
def ut_oric(ut_name, n_departments, n_teams , n_projects, unbalanced_flag):
    ...
    f_input1 = os.getcwd() + '/../ut_inputs/ut_ORIC/ut_'+ ut_name+'/N_TEAMS_pure.npy'
    ...
    f_input2 = os.getcwd() + '/../ut_inputs/ut_ORIC/ut_'+ ut_name+'/reward_project_pure.npy'
    ...
    f_input3 = os.getcwd() + '/../ut_inputs/ut_ORIC/ut_'+ ut_name+'/eq_constraint_to_oric_m_pure.npy'
    np.save(f_input3, eq_constraint_to_oric_m_pure.flatten())
        
    if (ut_name == "Oric2TeamUpdate"):

        f_output_path  = os.getcwd() + '/../ut_results/ut_ORIC/ut_'+ ut_name+'/oric_to_team_m_pure'
        ...
        f_input = os.getcwd() + '/../ut_inputs/ut_ORIC/ut_'+ ut_name+'/team_to_oric_m_pure.npy'
        np.save(f_input, team_to_oric_m_pure.flatten())
        
        oric_to_eq_constraint_m_pure, eq_constraint_to_project_m_pure = model_oric.oric_to_project_ec_update(eq_constraint_to_oric_m_pure, team_to_oric_m_pure)
        
        f_output_path1  = os.getcwd() + '/../ut_results/ut_ORIC/ut_'+ ut_name+'/oric_to_eq_constraint_m_pure'
        ...
        f_output_path2  = os.getcwd() + '/../ut_results/ut_ORIC/ut_'+ ut_name+'/eq_constraint_to_project_m_pure'
