...
def ut_io(ut_name, n_departments, n_teams, n_projects):
    ...
    f_reward_project_path = os.getcwd() + "/../ut_inputs/reward_project_pure.npy"
    ...
    if ut_name == "ExtrinsicOutputTeamUpdate":
        ...
        f_input2 = os.getcwd() + "/../ut_inputs/extrinsic_output_department_pure.npy"
        ...
        f_input3 = os.getcwd() + "/../ut_inputs/oric_to_team_m_pure.npy"
        np.save(f_input3, oric_to_team_m_pure.flatten())

        extrinsic_output_team_pure = outputs.extrinsic_output_team_update(extrinsic_output_department_pure, oric_to_team_m_pure)
        f_output_path = os.getcwd() + "/../ut_results/extrinsic_output_team_pure"
        ...
        f_input2 = os.getcwd() + "/../ut_inputs/oric_to_eq_constraint_m_pure.npy"
        ...
        f_input3 = os.getcwd() + "/../ut_inputs/project_to_eq_constraint_m_pure.npy"
        np.save(f_input3, project_to_eq_constraint_m_pure.flatten())

        intrinsic_out_mwm_pure = outputs.intrinsic_out_mwm_update(oric_to_eq_constraint_m_pure, project_to_eq_constraint_m_pure)
        f_output_path = os.getcwd() + "/../ut_results/intrinsic_out_mwm_pure"
        output_file_python_pure = open(f_output_path, "wb")
