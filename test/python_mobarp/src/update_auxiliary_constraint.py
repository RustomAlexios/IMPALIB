...
from environmentModule import np, np_impa_lib, zero_value, deepcopy
...
class AuxiliaryConstraintMOBARP:
    ...
    def auxiliary_const_to_z_eq_const_update(self, iter, mobile_x_eq_const_to_auxiliary_const_m, r_eq_const_to_auxiliary_const_m):
