...
if (not equal_arrays_metric):
    ...
    print('Minimum Difference Metric: ',np.min(np.min(abs(data_optimized_wrapper_metric-data_optimized_pure_metric))))
    print('Maximum Difference Metric: ',np.max(np.max(abs(data_optimized_wrapper_metric-data_optimized_pure_metric))))
