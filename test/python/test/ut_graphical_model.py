...
def ut_iterate(ut_name, N_u, team_types, filtering_flag, alpha, N_ITER, ppFlag, n_projects, threshold):
    np.random.seed(17)
    ...
    np.save(output_file_python1, ModelIMPA.extrinsic_output_team.flatten(), allow_pickle=True)
