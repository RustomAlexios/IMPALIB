...
if __name__ == '__main__':
    ...
    rtol=5e-02; atol = 1e-08 #user will specify these tolerances
    if (ut_name == "KnapsackForward" or ut_name == "KnapsackBackward"):
        ...
        file_array_pure1 = open(f_path_pure1, 'rb'); y_pure1 = np.load(file_array_pure1);
        y_wrapper1 = np.fromfile(f_path_wrapper1, dtype=np_impa_lib);
        check_agreement(sub_test_num, total_sub_tests, ut_name, y_pure1, y_wrapper1, rtol=rtol, atol = atol) 
        ...
        file_array_pure2 = open(f_path_pure2, 'rb'); y_pure2 = np.load(file_array_pure2);
        y_wrapper2 = np.fromfile(f_path_wrapper2, dtype=np_impa_lib);
        check_agreement(sub_test_num, total_sub_tests, ut_name, y_pure2, y_wrapper2, rtol=rtol, atol = atol)
    ...
    if (ut_name == "Oric2TeamUpdate" or ut_name == "ExtrinsicOutputTeamUpdate" or ut_name == "IntrinsicOutMwmUpdate" or ut_name == "TeamEc2OricUpdate" or ut_name == "ProjectEqConst2OricUpdate" \
        or ut_name == "ProjectInequalityConstraintUpdate" or ut_name == "ExtrinsicOutputDepartment" or ut_name == "Team2KnapsackUpdate"or ut_name == "ProcessExtrinsicOutputDepartment"):
