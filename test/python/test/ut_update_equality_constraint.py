...
def ut_eq_consraint(ut_name, n_departments, n_teams , n_projects):
    ...
    f_input1 = os.getcwd() + '/../ut_inputs/ut_EqConstraint/ut_'+ ut_name+'/N_TEAMS_pure.npy'
    ...
    f_input2 = os.getcwd() + '/../ut_inputs/ut_EqConstraint/ut_'+ ut_name+'/reward_project_pure.npy'
    ...
    if (ut_name == "TeamEc2OricUpdate"):
        ...
        f_input_path  = os.getcwd() + '/../ut_inputs/ut_EqConstraint/ut_'+ ut_name+'/extrinsic_output_department_pure'
        np.save(f_input_path, extrinsic_output_department_pure.flatten())
    
        f_output_path  = os.getcwd() + '/../ut_results/ut_EqConstraint/ut_'+ ut_name+'/team_to_oric_m_pure'
        ...
        f_input_path  = os.getcwd() + '/../ut_inputs/ut_EqConstraint/ut_'+ ut_name+'/project_to_eq_constraint_m_pure.npy'
        ...
        f_output_path  = os.getcwd() + '/../ut_results/ut_EqConstraint/ut_'+ ut_name+'/eq_constraint_to_oric_m_pure'
